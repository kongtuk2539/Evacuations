...
namespace Evacuations.Infrastructure.Migrations
{
    ...
    [Migration("20250524171602_Update-Field-StatusToEvacuationStatus")]
    partial class UpdateFieldStatusToEvacuationStatus
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Evacuations.Domain.Entities.Evacuations.EvacuationStatus", b =>
                {
                    ...
                    b.Property<Guid?>("EvacuationZoneId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Evacuations.Domain.Entities.Evacuations.EvacuationStatus", b =>
                {
                    b.HasOne("Evacuations.Domain.Entities.Evacuations.EvacuationZone", "EvacuationZone")
                        .WithMany()
                        .HasForeignKey("EvacuationZoneId");

                    b.HasOne("Evacuations.Domain.Entities.Evacuations.EvacuationZone", null)
